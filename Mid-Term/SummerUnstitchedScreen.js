...
const SummerUnstitchedScreen = () => {
  ...
  const products = [
    ...
    {
      id: 4,
      name: "Soft Voile Cotton",
      price: "₨ 799/meter",
      image: productImages.product4
    },
    {
      id: 5,
      name: "Flowy Georgette",
      price: "₨ 1,199/meter",
  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <View style={styles.pageHeader}>
        <Text style={styles.pageTitle}>Summer Fabrics</Text>
        <Text style={styles.pageSubtitle}>Lightweight materials for summer tailoring</Text>
      </View>
